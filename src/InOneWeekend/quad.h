...
inline shared_ptr<hittable_list> box(const point3& a, const point3& b, shared_ptr<material> mat)    //creates 3D box (six sides), two opposite vertices a & b
{
    auto sides = make_shared<hittable_list>();

    //two opposite vertices - min and max coords
